...
function spawnDominator(loc, type = false) {
    type = type ? type : ran.choose(["fort"]);
    let o = new Entity(loc);
    o.define(type);
...
const crasherConfig = {
    ...
    chance: 0.9,
    sentryChance: 0.25,
    crashers: [Class.crasher, Class.striker, Class.glitcher],
    sentries: [Class.sentryGun, Class.sentrySwarm, Class.sentryTrap, Class.cascaderGun, Class.cascaderSpeed, Class.cascaderBuild, Class.cataractPellet, Class.rogueBasic, Class.splitterSentrySwarm],
};
