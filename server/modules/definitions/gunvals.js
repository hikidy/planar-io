module.exports = {
    ...
    // Bases
    basic: { reload: 13.5, recoil: 1.4, shudder: 0.1, damage: 0.8, speed: 4.6, spray: 15.2 },
    drone: { reload: 45, recoil: 0.25, shudder: 0.1, size: 0.6, speed: 2.2, spray: 0.1 },
    trap: { reload: 30.8, shudder: 0.25, size: 0.6, damage: 0.88, speed: 5, spray: 15, resist: 3 },
    swarm: { reload: 16, recoil: 0.25, shudder: 0.05, size: 0.4, damage: 0.88, speed: 4, spray: 5 },
    factory: { reload: 58, shudder: 0.1, size: 0.7, damage: 0.75, speed: 3, spray: 0.1 },
    productionist: { reload: 72, recoil: 0.25, shudder: 0.05, size: 0.7, damage: 0.75, speed: 4, range: 1.5, spray: 5 },
    ...
    bent: { reload: 0.99, shudder: 0.8, health: 0.9, pen: 0.8, density: 0.8, spray: 0.5 },
    ...
    carnivore: { reload: 1, size: 0.98, health: 1.5, damage: 0.9, pen: 1.2, speed: 0.9, maxSpeed: 0.9 },
    ...
    // Pellets
    pellet: { reload: 0.75, recoil: 0.25, shudder: 1.35, size: 0.96, health: 1.215, damage: 0.210375, pen: 0.875, speed: 0.8, maxSpeed: 0.65, density: 1.5, spray: 1.8, range: 0.99, resist: 1.2 },

    // Machine guns
    mach: { reload: 0.5, recoil: 0.8, shudder: 1.7, health: 0.7, damage: 0.7, maxSpeed: 0.8, spray: 2.5 },
    pull: { shudder: 0.987, size: 0.997, health: 0.999, damage: 0.95, speed: 0.65, maxSpeed: 0.92, range: 0.875 },
    ...
    blaster: { reload: 0.88, recoil: 1.25, shudder: 1.25, size: 1.05, health: 0.95, damage: 1.1, pen: 1.1, speed: 0.8, maxSpeed: 0.465, range: 0.65, density: 0.5, spray: 1.5, resist: 0.8 },
    gravity: { reload: 0.625, shudder: 0.68, size: 0.8, health: 0.9, damage: 0.9, speed: 0.6, maxSpeed: 0.55, range: 0.675, density: 1.25, spray: 1.44, resist: 1.1 },
    ...
    trifront: { recoil: 0, speed: 1.3, maxSpeed: 1.1, range: 1.5 },
    halfthruster: { recoil: 2, shudder: 2, health: 0.8, damage: 0.55, pen: 0.7, spray: 0.4, resist: 0.1 },
    thruster: { recoil: 2.7, shudder: 2, health: 0.5, damage: 0.5, pen: 0.7, spray: 0.5, resist: 0.7 },
    ...
    machdrone: { reload: 0.85, recoil: 0.25, size: 1.1, health: 0.88, damage: 0.88, speed: 0.8, spray: 1.2 },
    ...
    // Heavy cannons
    pound: { reload: 2, recoil: 1.6, damage: 2, pen: 1.5, speed: 0.85, maxSpeed: 0.8, density: 1.5, resist: 1.15 },
    destroy: { reload: 2.2, recoil: 1.8, shudder: 0.5, health: 2, damage: 2, pen: 1.2, speed: 0.65, maxSpeed: 0.5, density: 2, resist: 3 },
    stabilize: { reload: 3, recoil: 2, damage: 5, speed: 3.1, maxSpeed: 3, density: 3.5, resist: 2.15 },
    anni: { reload: 0.8, recoil: 1.25 },
    mac: { reload: 1.9, recoil: 1.8, damage: 1.2, speed: 0.95, density: 1.5, resist: 1.5 },
    ...
    // Uzis
    uzi: { reload: 1.1, recoil: 0.6, size: 0.8, damage: 0.75, speed: 1.55 },
    flooder: { reload: 1.1, recoil: 0.1, damage: 0.7, speed: 0.99, spread: 1.5 },
    ...
    invent: { reload: 1.2, health: 1.6, damage: 1.2, size: 1.1, maxSpeed: 1.1 },
    ...
    muchmorespeed: { speed: 6, maxSpeed: 1.3 },
    ...
    // Damage
    moredamage: { damage: 1.2 },
    mostdamage: { damage: 2 },
    lessdamage: { damage: 0.8 },

    // Health
    morehealth: { health: 1.2 },
    lesshealth: { health: 0.8 },
    ...
    // Dropships
    dropship: { reload: 53, recoil: 1, shudder: 0.0001, size: 0.9, health: 2.25, damage: 0.8, pen: 1.25, speed: 4.15, maxSpeed: 0, range: 1, density: 1, spray: 0.0001, resist: 1 },
    ...
    bigger: { size: 8 },
    splatter: { reload: 220, recoil: .175, shudder: .135, size: 1.2,health: 2.352, damage: .0464, pen: 1.25, speed: 3.96, maxSpeed: .65, density: 1.5, spray: 27, resist: 1.2 },
    precice: { shudder: 0.0001, resist: 0.001},

    // Bosses
    djynnswarm: { reload: 0.7, recoil: 0.25, shudder: 1.02, damage: 3, speed: 1.2, range: 5, spray: 5 },
    djynnhome: {reload: 0.99, recoil: 0.2, shudder: 0.245, health: 1.5, damage: 3, pen: 1.5, speed: 1.8, maxSpeed: 1.5, density: 1.5, spray: 0.2, resist: 1.158888888},
}
