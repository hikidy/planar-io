...
exports.anniShot = {
    ...
    GUNS: [
        {
            POSITION: [15.5, 19.5, 1, 0, 0, -50, 0.5],
            PROPERTIES: {
        ...
        {
            POSITION: [16.5, 19.5, 1, 0, 0, -40, 0.4],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.destroy, g.anni]),
                TYPE: "bullet",
            },
        ...
        {
            POSITION: [17.5, 19.5, 1, 0, 0, -30, 0.3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.destroy, g.anni]),
                TYPE: "bullet",
            },
        ...
        {
            POSITION: [18.5, 19.5, 1, 0, 0, -20, 0.2],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.destroy, g.anni]),
                TYPE: "bullet",
            },
        ...
        {
            POSITION: [19.5, 19.5, 1, 0, 0, -10, 0.1],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.destroy, g.anni]),
                TYPE: "bullet",
            },
...
exports.fakeSplitterPentagon = {
    PARENT: ["genericTank"],
    LABEL: "Fake Splitter Pentagon",
    SHAPE: [[0,0]],
    BORDERLESS: true,
    COLOR: 6,
    GUNS: [],
...
for(let i = 0; i < 5; i++) {
    exports.fakeSplitterPentagon.GUNS.push(
        {
            POSITION: [11, 15, -0.000000000000000001, 1.5, 0, (360/5)*i, 0],
            PROPERTIES: {
                COLOR: 5
            },
        },
...
exports.splitterSentrySwarmt = {
    PARENT: ["genericTank"],
    LABEL: "Splitter Sentry Swarm",
    SHAPE: [[0,0]],
    BORDERLESS: true,
    COLOR: 6,
    GUNS: [],
...
for(let i = 0; i < 5; i++) {
    exports.splitterSentrySwarmt.GUNS.push(
        {
            POSITION: [2.7, 6.16, 0.6, 13, 0, (360/5)*i + 180 + 36, 0 + i * 0.2],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.swarm, g.morerecoil, g.puregunner, g.puregunner, g.debuff1, g.debuff1, g.morespeed, g.morespeed, g.lessreload]),
                TYPE: ["swarm", { COLOR: 5 }],
...
exports.radicalSpawner = {
    PARENT: ["genericTank"],
    LABEL: "Radical Spawner",
    DANGER: 6,
    STAT_NAMES: statnames.drone,
    BODY: {
    ...
    TOOLTIP: "fuck you all, i will spawn elites now",
    GUNS: [
        {
            /**** LENGTH    WIDTH     ASPECT        X             Y         ANGLE     DELAY */
            POSITION: [4.5, 25, 1, 10.5, 0, 0, 0],
        },
        {
            POSITION: [1, 27, 1, 15, 0, 0, 0],
            PROPERTIES: {
                MAX_CHILDREN: 1,
                SHOOT_SETTINGS: combineStats([g.factory, g.babyfactory]),
                TYPE: ["eliteTrapGuard", {INDEPENDENT: true, 
    ...
    CONTROLLERS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                MAX_CHILDREN: 1,
                SHOOT_SETTINGS: combineStats([g.factory, g.babyfactory]),
                TYPE: ["eliteSpawner", {INDEPENDENT: true, 
    ...
    CONTROLLERS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                MAX_CHILDREN: 1,
                SHOOT_SETTINGS: combineStats([g.factory, g.babyfactory]),
                TYPE: ["eliteBattleship", {INDEPENDENT: true, 
    ...
    CONTROLLERS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                MAX_CHILDREN: 1,
                SHOOT_SETTINGS: combineStats([g.factory, g.babyfactory]),
                TYPE: ["eliteSprayer", {INDEPENDENT: true, 
    ...
    CONTROLLERS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                MAX_CHILDREN: 1,
                SHOOT_SETTINGS: combineStats([g.factory, g.babyfactory]),
                TYPE: ["eliteGunner", {INDEPENDENT: true, 
    ...
    CONTROLLERS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                MAX_CHILDREN: 1,
                SHOOT_SETTINGS: combineStats([g.factory, g.babyfactory]),
                TYPE: ["eliteSpinner", {INDEPENDENT: true, 
        ...
        },
        {
            ...
            PROPERTIES: {
                MAX_CHILDREN: 1,
                SHOOT_SETTINGS: combineStats([g.factory, g.babyfactory]),
                TYPE: ["eliteDestroyer", {INDEPENDENT: true, 
...
exports.developer.UPGRADES_TIER_0 = ["basic", "healer", "spectator", "miscEntities", "eggGenerator", "bosses", "fun", "levels", "teams", "oldTanks", "scrappedTanks", "shapes"];
    ...
    exports.bosses.UPGRADES_TIER_0 = ["sentries", "elites", "mysticals", "nesters", "rogues", "terrestrials", "celestials", "eternals", "devBosses", "polyBosses", "awps", "otherBosses"];
        ...
        exports.elites.UPGRADES_TIER_0 = ["eliteDestroyer", "eliteGunner", "eliteSprayer", "eliteBattleship", "eliteSpawner", "eliteTrapGuard", "eliteRammer", "eliteSpinner", "eliteSkimmer", "legionaryCrasher", "sprayerLegion"];
        ...
        exports.celestials.UPGRADES_TIER_0 = ["paladin", "freyja", "zaphkiel", "nyx", "theia", "aetherion", "ouranios"];
        exports.eternals.UPGRADES_TIER_0 = ["ragnarok", "kronos"];
        exports.devBosses.UPGRADES_TIER_0 = ["taureonBoss", "tgsBoss"];
        exports.polyBosses.UPGRADES_TIER_0 = ["summoner", "defender", "leviathan"];
        exports.otherBosses.UPGRADES_TIER_0 = ["FK1", "homingdjynn"];
        exports.awps.UPGRADES_TIER_0 = ["awpPistolstar"];
    ...
    exports.shapes.UPGRADES_TIER_0 = ["dualSine", "arkansas", "amongUs", "florida", "mogusBody", "switcherOO", "fakeSplitterPentagon", "splitterSentrySwarmt"]
...
"gaytwin", "yskysn", "anniShot", "skintest", "radicalSpawner"];
