...
exports.awp = {
    ...
    COLOR: 13,
    BROADCAST_MESSAGE: "Rest in peace, amalgamation of steel and silicon, as your circuits succumb to the embrace of eternal silence."
};
...
for(let i = 0; i < 5; i++) {
    exports.awpPistolstar.TURRETS.push(
        {
            POSITION: [15, 16, 0, ( 360 / 5) * i + ( ( 360 / 5) / 2 ), 0, 0],
            TYPE: ["squareBullet", { SHAPE: 4, COLOR: 14, TURRET_FACES_CLIENT: true}]
        },
        {
            POSITION: [9.6, 27, 0, ( 360 / 5) * i + ( ( 360 / 5) / 2 ), 0, 0],
            TYPE: ["triBullet", { SHAPE: 4, COLOR: 14, TURRET_FACES_CLIENT: true}]
        },
    )
};
for(let i = 0; i < 5; i++) {
    exports.awpPistolstar.TURRETS.push(
        {
            POSITION: [7.5, 15, 0, ( 360 / 5) * i + ( ( 360 / 5) / 2 ), 360, 1],
            TYPE: ["awpPSsnipe", {
    ...
    GUNS: [
        {
            ...
            POSITION: [40, 8, 1.62, 16.5, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assass, g.machgun, g.chain, g.power, g.weak, g.power, g.debuff1, g.slow, g.slow, g.slow, g.slow, g.morereload, g.morereload, g.morereload, g.morereload]),
                TYPE: "bullet",
            },
        },
        {
            POSITION: [6.5, 8.5, -1.6, 8, 0, 0, 0],
        },
    ],
    TURRETS: [
...
exports.homingdjynn = {
        ...
        POSITION: [  9.5,     9,      2.5,     45,    360,  1,], 
        TYPE: ["autoTurrethoming", { CONTROLLERS: ['nearestDifferentMaster'], INDEPENDENT: true, }],
        }, {/*********  SIZE               X       Y     ANGLE    ARC */
        POSITION: [  9.5,     9,      -2.5,     -45,    360,  1,], 
        TYPE: ["autoTurrethoming", { CONTROLLERS: ['nearestDifferentMaster'], INDEPENDENT: true, }],
        }, ],
...
exports.FK1 = {
    PARENT: ["miniboss"],
    //SHAPE: [[-1,0.5],[-0.8,0],[-1,-0.5],[-1,-1],[1,0],[-1,1]],
    SHAPE: [[-0.6,-1],[0.6,0],[-0.6,1]],
    COLOR: 33,
    LABEL: "FK-1",
    FACING_TYPE: "toTarget",
    SIZE: 27,
    ...
    GUNS: [
        {
            POSITION: [8, 11, 1, 5, 0, 180, 0],
        },
        {
            POSITION: [3, 11, 1.4, 13, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.power, g.morereload, g.morereload, g.morerecoil]),
                TYPE: "trap",
                STAT_CALCULATOR: gunCalcNames.trap,
            },
        },
        {
            POSITION: [8, 6, 1.4, 5, 5.5, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.drone, g.over, g.meta, g.power, g.machdrone, g.pound]),
                TYPE: "drone",
        ...
        {
            POSITION: [8, 6, 1.4, 5, -5.5, 180, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.drone, g.over, g.meta, g.power, g.machdrone, g.pound]),
                TYPE: "drone",
                STAT_CALCULATOR: gunCalcNames.drone,
    ...
    TURRETS: [
        {
            POSITION: [8.75, 5, 2, 45, 180, 0],
            TYPE: ["megaAutoTankgun", { COLOR: 34 }]
        },
        {
            POSITION: [8.75, 5, -2, -45, 180, 0],
            TYPE: ["megaAutoTankgun", { COLOR: 34 }]
...
exports.eliteRammer = {
    ...
    BODY: {
        ...
        HEALTH: 7 * base.HEALTH,
        DAMAGE: 3.1 * base.DAMAGE,
    },
    TURRETS: [
        {
            POSITION: [22.2, 0, 0, 360, 0, 0],
            TYPE: ["drone", { COLOR: 9, }],
        },
        {
            POSITION: [10, -2, 0, 0, 20, 1],
            TYPE: "eliteRammerTriAngle",
        }
    ],
    GUNS: [
        {
            POSITION: [9, 9, 1, 2, 5.5, 180, 0.2],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.destroy, g.anni, g.moredamage, g.thruster, g.machgun, g.morehealth, g.bitlessspeed]),
                TYPE: "bullet",
            },
        },
        {
        ...
        {
            POSITION: [12.5, 8, 1, 0, 3.9, 180, 0.1],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pound, g.destroy, g.anni, g.moredamage, g.thruster, g.machgun, g.morehealth, g.bitlessspeed]),
                TYPE: "bullet",
            },
...
exports.leviathan = {
    ...
    GUNS: Array(5).fill().map((_, i) => ({
        POSITION: [3.5, 7.65, 1.1, 8, 0, (i * 72) + 144, 0],
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.drone, g.summoner, { size: 0.8 }]),
            TYPE: ["sunchip"],
            AUTOFIRE: true,
...
exports.ouraniosUpperBody = {
    ...
    TURRETS: [
        {
            /*********    SIZE         X             Y         ANGLE        ARC */
            POSITION: [10, 7.5, 0, 60, 160, 0],
            TYPE: ["swarmerTurret"],
        },
        {
            POSITION: [10, 7.5, 0, 120, 160, 0],
            TYPE: ["swarmerTurret"],
        },
        {
            POSITION: [10, 7.5, 0, 180, 160, 0],
        ...
        {
            POSITION: [10, 7.5, 0, 240, 160, 0],
            TYPE: ["swarmerTurret"],
        },
        {
            POSITION: [10, 7.5, 0, 300, 160, 0],
            TYPE: ["swarmerTurret"],
        },
        {
            POSITION: [10, 7.5, 0, 360, 160, 0],
            TYPE: ["swarmerTurret"],
        },
    ],
};
exports.ouranios = {
    ...
    TURRETS: [
        {
            /*********    SIZE         X             Y         ANGLE        ARC */
            POSITION: [6.5, 9, 0, 72, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 144, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 216, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 288, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 360, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 468, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 540, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 612, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 684, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [6.5, 9, 0, 756, 180, 0],
            TYPE: ["baseTrapTurret", { INDEPENDENT: true }],
        },
        {
            POSITION: [14.94, 0, 0, 0, 360, 1],
            TYPE: ["ouraniosLowerBody"],
        },
        {
            POSITION: [8.6, 0, 0, 0, 360, 1],
            TYPE: ["ouraniosUpperBody"],
        },
    ],
};
...
for(let i = 0; i < 7; i++) {
    exports.aetherionLowerBody.GUNS.push(
        {
            /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
            POSITION: [12, 4, 1, 5, 0, 360 / 7 * i + ( (360 / 7 ) / 2), 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.hunter, g.hunter2, g.power]),
                TYPE: "bullet",
            },
        },
        {
            POSITION: [10.5, 6, 1, 5, 0, 360 / 7 * i + ( (360 / 7 ) / 2), 0.25],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.hunter, g.power]),
                TYPE: "bullet",
            },
        },
    )
};
exports.aetherionUpperBody = {
    LABEL: "",
    CONTROLLERS: [["spin", { independent: true, speed: 0.005 }]],
    AUTOSPIN: true,
    COLOR: 39,
...
for(let i = 0; i < 7; i++) {
    exports.aetherionUpperBody.TURRETS.push(
        {
            POSITION: [10, 7.5, 0, 360 / 7 * i + ( (360 / 7 ) / 2), 350, 0],
            TYPE: ["triGunner", {
                CONTROLLERS: [
                    "canRepel",
                    "onlyAcceptInArc",
...
exports.aetherion = {
    ...
    TURRETS: [
        ...
        {
            POSITION: [14.94, 0, 0, 0, 360, 1],
            TYPE: "aetherionLowerBody",
        },
        {
            POSITION: [8.6, 0, 0, 0, 360, 1],
            TYPE: "aetherionUpperBody",
        },
    ],
};
