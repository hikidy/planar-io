...
exports.glitcher = {
    ...
    LABEL: "Glitcher",
    COLOR: 36,
    SHAPE: [[-0.61,-0.64],[0.15,-0.67],[-1.21,0.3],[0.227,-1.13],[-0.53,0.99],[-0.19,0.39],[-0.8,0.2],[0.4,0.6],[-0.17,-0.64],[-0.6,0.4],[0.6,0.4],[0.6,-1.2],[0.633,1.13],[1,-1.4],[1.2,0.8],[-0.95,0.48],[0.6,0],[1.2,1],[-0.47,-0.98],[-0.4,1],[-1.8,-1],[-1.6,1.6],[0.2,-0.4],[-0.8,-1.2],[1.6,-0.2],[-1.6,1],[-0.6,1],[-1,1.2],[1.8,-1.2],[-1.6,-1.6],[1,-0.2],[2,-1.2],[0.4,-0.8],[0.2,0.6],[-1.4,-1.2],[0.4,1],[-1,-0.2]],
    SIZE: 2,
    ...
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.puregunner, g.debuff1]),
                TYPE: "bullet",
                COLOR: 16,
                LABEL: "",
                STAT_CALCULATOR: 0,
...
exports.splitterSentrySwarm = {
    PARENT: ["sentry"],
    LABEL: "Splitter Sentry Swarm",
    SHAPE: [[0,0]],
    BORDERLESS: true,
    COLOR: 6,
    BOSS_TYPE: 'splitterSentrySwarm',
    GUNS: [],
};
for(let i = 0; i < 5; i++) {
    exports.splitterSentrySwarm.GUNS.push(
        {
...
exports.cataractPellet = {
    PARENT: ["sentry"],
    LABEL: "Cascader",
    SHAPE: [[-1,0],[0,-1],[1,-0.5],[1,-0.3],[1.2,-0.3],[1.2,0.3],[1,0.3],[1,0.5],[0,1]],
    COLOR: '#FF569A',
    SIZE: 15,
    GUNS: [
        {
            POSITION: [7, 2, 1, 7, 1.3, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.puregunner]),
                TYPE: "bullet",
            },
        },
        {
            POSITION: [7, 2, -1, 7, -1.3, 0, 0.1],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.puregunner]),
                TYPE: "bullet",
            },
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assass, g.anni, g.puregunner]),
                TYPE: "bullet",
            },
        },
        {
...
exports.fort = {
    ...
    COLOR: 34,
    FACING_TYPE: "autospin",
    CONTROLLERS: ["mapAltToFire", "minion", ["mapFireToAlt", { onlyIfHasAltFireGun: true }]],
    TURRETS: [
        {
